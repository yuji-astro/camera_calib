...
for img_path_left, img_path_right in zip(image_paths_left, image_paths_right):
    ...
    ret_left, corners_left = cv2.findCirclesGrid(gray_left, chessboard_size, None, cv2.CALIB_CB_SYMMETRIC_GRID)
    ret_right, corners_right = cv2.findCirclesGrid(gray_right, chessboard_size, None, cv2.CALIB_CB_SYMMETRIC_GRID)
